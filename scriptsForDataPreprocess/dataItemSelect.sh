...
#head $dataPath_2017/batch_instance-with_heads.csv
awk -F , 'END{print "lines="NR;}'  $dataPath_2017/batch_instance.csv $dataPath_2017/batch_instance.csv
awk -F , 'END{print "lines="NR;}'  $dataPath_2017/batch_instance.csv $dataPath_2017/batch_instance-with_heads.csv
csvkit
