...
awk -F , 'BEGIN{} { if( $1 > 0 && $2 > $1 && $6 == "Terminated" && $9 > 0 && $10 > 0 && $11 > 0 && $12 > 0 ) { print $1","$2","$9","$10","$11","$12  > $dataPath_2017/batch_instance_just_selected.csv; }' $dataPath_2017/batch_instance.csv
